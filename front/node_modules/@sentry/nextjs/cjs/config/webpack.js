...
function constructWebpackConfigFunction(
  ...
  var newWebpackFunction = (incomingConfig, buildContext) => {
    ...
    var enableWebpackPlugin =
      ...
      (buildContext.isServer
        ? !_optionalChain([userNextConfig, 'access', _ => _.sentry, 'optionalAccess', _2 => _2.disableServerWebpackPlugin])
        : !_optionalChain([userNextConfig, 'access', _3 => _3.sentry, 'optionalAccess', _4 => _4.disableClientWebpackPlugin]));
    ...
    if (enableWebpackPlugin) {
      ...
      if (!buildContext.dev) {
        ...
        newConfig.devtool =
          _optionalChain([userNextConfig, 'access', _5 => _5.sentry, 'optionalAccess', _6 => _6.hideSourceMaps]) && !buildContext.isServer ? 'hidden-source-map' : 'source-map';
      }
...
async function addSentryToEntryProperty(
  ...
  if (isServer && !isDev) {
    var rewriteFramesHelper = path.resolve(
...
function getWebpackPluginOptions(
  ...
  var clientInclude = _optionalChain([userNextConfig, 'access', _7 => _7.sentry, 'optionalAccess', _8 => _8.widenClientFileUpload])
  ...
  var defaultPluginOptions = utils.dropUndefinedKeys({
    include: isServer ? serverInclude : clientInclude,
    ignore:
      isServer || !_optionalChain([userNextConfig, 'access', _9 => _9.sentry, 'optionalAccess', _10 => _10.widenClientFileUpload])
        ? []
...
exports.SentryWebpackPlugin = SentryWebpackPlugin.default;
